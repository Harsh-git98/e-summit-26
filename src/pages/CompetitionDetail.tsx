    ...
    <Layout>
      ...
      <section className="relative h-96 md:h-[500px] overflow-hidden">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">{competition.team}</p>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="glass rounded-xl p-4 text-center">
              ...
              <p className="font-semibold text-sm">{competition.team}</p>
            </div>
            
            <div className="glass rounded-xl p-4 text-center">
              <Trophy size={24} className="mx-auto mb-2 text-secondary" />
              <p className="text-xs text-muted-foreground mb-1">Prize Pool</p>
              <p className="font-semibold text-sm">{competition.prizes.split("+")[0].trim()}</p>
            </div>
            ...
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                >
                  ...
                  <div className="mt-8 p-6 glass rounded-xl border-l-4 border-primary">
                    ...
                    <p className="text-md">{competition.prizes}</p>
                  </div>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="rules" className="space-y-6">
                <motion.div
                  ...
                  transition={{ duration: 0.4 }}
                >
                  <h2 className="text-2xl md:text-3xl font-heading font-bold mb-6">Rules & Guidelines</h2>
                  ...
                  <div className="space-y-4 mb-8">
                    {competition.rules.map((rule, i) => (
                      ...
                      >
                        ...
                        <p className="text-sm md:text-base pt-1">{rule}</p>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  >
                    <p className="text-sm text-yellow-200">
                      ⚠️ Note: Violation of any rule may lead to disqualification. Make sure to read the complete rulebook before registering.
                    </p>
                  </motion.div>
