      ...
      >
        ...
        <div className="text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight flex flex-col items-center lg:items-start"
          >
            <span className="mt-4 bg-gradient-to-br from-purple-100 via-fuchsia-300 to-sky-100 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(168,85,247,0.75)] text-center lg:text-left">
              Scintillations
            </span>
            <span className="mt-3 text-[1rem] sm:text-xl md:text-2xl text-white/85 tracking-[0.35em] uppercase text-center lg:text-left">
              E-Summit 2026
            </span>
          </motion.h1>
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-2 justify-center lg:justify-start">
            <MagneticButton>
              <UnstopCTA href="/events" isExternal={false} />
            </MagneticButton>
